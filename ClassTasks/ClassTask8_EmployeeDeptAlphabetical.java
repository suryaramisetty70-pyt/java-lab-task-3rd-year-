...
public class ClassTask8_EmployeeDeptAlphabetical {
    ...
    public static void main(String[] args) {
        List<Employee> employees = new ArrayList<>(List.of(
            ...
            new Employee(104, "David", "Admin", 60000)
        ));
        ...
        System.out.println("\nAfter Sorting by Department Alphabetically:");
        employees.forEach(System.out::println);
    }
}
...
Employee{id=104, name='David', dept='Admin', salary=60000.0}
